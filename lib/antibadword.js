...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
    ...
    // List of bad words
    const badWords = [
        'bablu', 'matkarnabhai', 'notallowed', 'bsdk', 'ghaddar', 'bawo', 
        'bawooo', 'matkarna', 'not', 'notallowed', 'baskhatam', 'bablo', 
        'ghaddar', 'tatto', 'machar', 'bawo', 
        'noob', 'noooo', 'bann', 'matkaro', 'karaila', 'mango', 'tomato', 'noooo', 
        'dick', 'bitch', 'bastard', 'asshole', 'asu', 'awyu', 'teri ma ki chut', 
        'please', 'bablooo', 'nakaro', 'mc', 'laddu', 'bawooooo',
